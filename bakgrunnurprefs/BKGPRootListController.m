...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        //Manage Apps - 使用自实现的列表控制器，无需 AltList 依赖
        PSSpecifier *altListSpec = [PSSpecifier preferenceSpecifierNamed:@"管理应用" target:nil set:nil get:nil detail:NSClassFromString(@"BKGPApplicationListSubcontrollerController") cell:PSLinkCell edit:nil];
